...
This program functions as a very basic calculator. It also
demonstrates the use of error handling in the case of trying
to divide by 0. 
*/
...
int main () {
    ...
    struct sigaction new_handler, ctrlc_handler;
    ...
    ctrlc_handler.sa_handler = handle_SIGINT;
